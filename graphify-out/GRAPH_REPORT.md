...
2. `Overview / Get Started Page (Before)` - 11 edges
3. `BPS Data Table` - 10 edges
4. `Get Started Overview Page (TW4 After)` - 8 edges
5. `Lambang BPS Indonesia (Official Emblem)` - 8 edges
6. `UPGRADE_NOTES v3→v4 Migration` - 7 edges
7. `Badan Pusat Statistik (BPS) Indonesia` - 7 edges
8. `BPS Logo` - 7 edges
9. `Three-Layer Color Token System` - 6 edges
...
- **v4 CSS-First Consumer Style Entries** — readme_styles_css, readme_tokens_css, readme_fonts_css, arch_css_first_tailwind4, design_md_tailwind_preset_deprecated [EXTRACTED 1.00]
- **Library and Showcase Dual Operating Modes** — arch_dual_mode, index_ts_public_exports, app_tsx_showcase_router, readme_showcase_production, arch_vite_lib_config [INFERRED 0.85]
- **Portal Statistik Internal page shell** — listpage_page, detailpage_page, settingspage_page, portal_app_topbar_shell [INFERRED 0.90]
- **Document submission and approval workflow** — formworkflowpage_doc_stepper, detailpage_doc_review, settingspage_approval_policy, listpage_doc_list [INFERRED 0.85]
- **Dashboard KPI metric card family** — dashboardpage_exec_kpis, performancecardpage_page, uikit_statcard [INFERRED 0.80]
- **Post-TW4 DataTable Page Shows Only Warm Canvas** — tw4_after_datatable_screenshot, tw4_after_datatable_blank_viewport, tw4_after_datatable_warm_canvas, tw4_after_datatable_missing_ui, tw4_after_datatable_migration_capture [INFERRED 0.90]
- **Civic Editorial Visual Identity System** — tw4_after_overview_civic_editorial, tw4_after_overview_magazine_meta, tw4_after_overview_drop_cap, tw4_after_overview_serif_sans_contrast, tw4_after_overview_burnt_orange_accent [EXTRACTED 0.95]
- **Design System Showcase Shell Layout** — tw4_after_overview_two_column_layout, tw4_after_overview_sidebar_nav, tw4_after_overview_main_content, tw4_after_overview_nav_groups [EXTRACTED 1.00]
- **Design System Purpose for BPS Internal Apps** — tw4_after_overview_purpose_rationale, tw4_after_overview_data_first_swiss, tw4_after_overview_bps_kaltara_audience, tw4_after_overview_maksud_section [EXTRACTED 0.92]
- **Three Design Pillars on Overview** — tw4_before_pillar_fondasi_modern, tw4_before_pillar_komponen_enterprise, tw4_before_pillar_layout_data_dense [EXTRACTED 1.00]
- **Showcase Information Architecture** — tw4_before_nav_overview, tw4_before_nav_foundations, tw4_before_nav_components, tw4_before_nav_prototypes [EXTRACTED 1.00]
- **Before-State Visual Language** — tw4_before_cream_warm_background, tw4_before_navy_amber_palette, tw4_before_serif_editorial_type, tw4_before_design_philosophy [INFERRED 0.85]
- **Data Status Badge Color Variants** — tw4_after_table_status_approved, tw4_after_table_status_pending, tw4_after_table_status_revised [EXTRACTED 1.00]
- **Data Table Showcase Layout Composition** — tw4_after_table_sidebar_nav, tw4_after_table_data_table_page, tw4_after_table_bps_data_table, tw4_after_table_serif_sans_typography [INFERRED 0.80]
- **Empty Pre-TW4 Data Table Baseline Capture** — tw4-before-datatable_screenshot_artifact, tw4-before-datatable_blank_warm_canvas, tw4-before-datatable_missing_ui_content, tw4-before-datatable_pre_tailwind4_baseline, tw4-before-datatable_intended_datatable_view [INFERRED 0.75]
- **BPS Tricolor Letterforms (b-p-s)** — lambang_bps_indonesia_letter_b, lambang_bps_indonesia_letter_p, lambang_bps_indonesia_letter_s [EXTRACTED 1.00]
- **BPS Brand Color Triad (Blue-Green-Orange)** — lambang_bps_indonesia_color_blue, lambang_bps_indonesia_color_green, lambang_bps_indonesia_color_orange [EXTRACTED 1.00]
- **Official BPS Emblem Composition** — lambang_bps_indonesia_emblem, lambang_bps_indonesia_acronym_bps, lambang_bps_indonesia_orbital_ring, lambang_bps_indonesia_geometric_style [EXTRACTED 1.00]
- **BPS Logo Visual Composition** — favicon_navy_shield_shape, favicon_cream_inner_panel, favicon_orange_top_accent, favicon_beige_accent_mark [EXTRACTED 1.00]
- **BPS Brand Color Palette** — favicon_navy_blue_color, favicon_orange_color, favicon_cream_color [EXTRACTED 1.00]
- **BPS Logo Brand Color Palette** — ds_logo_navy_primary, ds_logo_orange_accent, ds_logo_cream_panel, ds_logo_warm_circle [EXTRACTED 1.00]
- **BPS Emblem Visual Composition** — ds_logo_bps_shield_mark, ds_logo_percent_glyph, ds_logo_orange_accent, ds_logo_warm_circle [EXTRACTED 1.00]
- **BPS Monogram Composition** — bps-logo_letter_b, bps-logo_letter_p, bps-logo_letter_s, bps-logo_elliptical_ring [EXTRACTED 1.00]
- **BPS Brand Identity Elements** — bps-logo_bps_logo, bps-logo_brand_palette, bps-logo_geometric_letterforms, bps-logo_design_system_brand_asset [INFERRED 0.80]
...
- `@bpsprovkaltara/design-system` → `Kinara Design System (ASN Performance)`  [AMBIGUOUS]
  design/DESIGN.md · relation: conceptually_related_to
- `v3 LTS Release Track (legacy)` → `Security Policy (Internal Tool)`  [AMBIGUOUS]
  SECURITY.md · relation: conceptually_related_to
- `Blank Warm Off-White Canvas` → `Intended Data Table Showcase View`  [AMBIGUOUS]
  tw4-before-datatable.png · relation: semantically_similar_to
- `Pre-Tailwind 4 Visual Baseline` → `Empty Capture / Failed Screenshot`  [AMBIGUOUS]
...
- **What is the exact relationship between `@bpsprovkaltara/design-system` and `Kinara Design System (ASN Performance)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `v3 LTS Release Track (legacy)` and `Security Policy (Internal Tool)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **What is the exact relationship between `Blank Warm Off-White Canvas` and `Intended Data Table Showcase View`?**
