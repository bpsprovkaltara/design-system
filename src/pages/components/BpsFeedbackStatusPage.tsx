...
import { BpsConfirmActionDialog } from '@/components/ui/bps-confirm-action-dialog'
...
export function BpsFeedbackStatusPage() {
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <ShowcaseSection title="Alert + Dialog Konfirmasi + Progress">
        <div className="space-y-4">
          ...
          <BpsProgressAudit totalChecklist={12} completedChecklist={10} />
        </div>
      </ShowcaseSection>

      <ShowcaseSection title="Timeline Review">
        <BpsReviewTimeline items={timelineData} />
      </ShowcaseSection>
    </div>
  )
}
