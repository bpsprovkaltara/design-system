/**
 * BPS Kaltara Design System — Tailwind Preset
 *
...
const bpsPreset: Partial<Config> = {
  darkMode: ['class'],
  theme: {
    extend: {
      colors: {
