...
function ToastTitle({ className, ...props }: React.ComponentProps<typeof ToastPrimitives.Title>) {
  return (
    <ToastPrimitives.Title
      ...
      className={cn('text-body-sm font-semibold [&+div]:text-caption', className)}
      {...props}
    />
  )
}
